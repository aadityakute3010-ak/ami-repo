...
public class UserController {
    ...
    public AdminUpdateUserResponseDto adminUpdateUser(@Valid @PathVariable Long userId,@RequestBody AdminUpdateUserRequestDto request) {
    ...
    public PagedUserResponseDto searchUsers(@RequestParam String keyword,
                                            @RequestParam(defaultValue = "0") int page,
                                            @RequestParam(defaultValue = "10") int size)
    {
